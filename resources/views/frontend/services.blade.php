  ...
  <div class="bg-black service-section">
    <div class="row mx-0">
      <div class="col-md-6 pt-5 pb-4 pb-md-5 service-content">
        ...
        <a href="#bookNowModal" data-bs-toggle="modal" class="btn-4-white rounded pointer animate-from-bottom"><span>Book Now</span></a>
      </div>
  ...
  <div class="service-section">
    <div class="row mx-0">
      <div class="col-md-6 pt-5 pb-4 pb-md-5 service-content">
        ...
        <a href="#bookNowModal" data-bs-toggle="modal" class="btn-4 rounded pointer animate-from-bottom"><span>Book Now</span></a>
      </div>
